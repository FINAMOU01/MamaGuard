...
class _LinkDoctorScreenState extends State<LinkDoctorScreen> {
  ...
  Future<void> _linkDoctor() async {
    ...
    if (code.isEmpty) {
      _showError('Entrez le code de liaison du médecin');
      return;
    }
    ...
    try {
      ...
      if (r.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Lié au Dr ${data['doctor_name']}'),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('Mon médecin', style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: Colors.white)),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: const Icon(Icons.medical_services_rounded, color: AppConstants.softPink, size: 32),
          ),
          const SizedBox(height: 16),
          const Text('Entrez le code de liaison', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700, color: Color(0xFF2D2D2D))),
          const SizedBox(height: 6),
          Text('Demandez ce code à votre médecin', style: TextStyle(fontSize: 13, color: Colors.grey[600])),
          const SizedBox(height: 20),
          TextField(
            controller: _codeCtrl,
            textCapitalization: TextCapitalization.characters,
            textAlign: TextAlign.center,
            style: const TextStyle(fontSize: 24, fontWeight: FontWeight.w700, letterSpacing: 6, color: Color(0xFF2D2D2D)),
            decoration: InputDecoration(
              hintText: 'ABCDEF',
              hintStyle: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, letterSpacing: 6, color: Colors.grey[300]),
              filled: true,
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text(_isLinking ? 'Liaison...' : 'Lier mon médecin'),
